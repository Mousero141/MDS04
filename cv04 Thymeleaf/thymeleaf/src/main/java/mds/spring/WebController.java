...
public class WebController {
    ...
    */
    ...
    @GetMapping("/testDynam")
    public String testDynam(Model model){
        model.addAttribute("name", "Matej Valicek");
        model.addAttribute("narozeni", "14.05.2001");
        return "testDynam";
    }
